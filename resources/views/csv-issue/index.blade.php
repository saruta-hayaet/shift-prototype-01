<x-app-layout>
    ...
    <div class="main">
        <form action="{{route('csv-issue.show')}}" method="POST">
            @csrf
            ...
            <select id="project" name="project" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-200 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
